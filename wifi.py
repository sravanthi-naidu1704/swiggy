...
# Replace non-breaking spaces (U+00A0) and any unwanted characters with normal spaces
data = data.replace(chr(0xA0), ' ')  # Replace U+00A0 (non-breaking space) with a regular space
